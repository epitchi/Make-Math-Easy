...
class TSHSB3_TimMNBtrenabPage extends StatefulWidget {
  @override
  _TSHSB3_TimMNBtrenabPageState createState() =>
      _TSHSB3_TimMNBtrenabPageState();
}

List listAnswer = new List<String>();

class _TSHSB3_TimMNBtrenabPageState extends State<TSHSB3_TimMNBtrenabPage> {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                      "Tìm m để hàm số y = (am+b)x^3 +(cm+d)x^2+(em+f)x+gm+h nghịch biến trên (p,q)"),
                  typeFunction != -1
                      ? Column(
                          children: [
                            ...
                            Text(
                                "Tìm m để hàm số bậc 3: y = ( ${aTextEditingController.text}.m+${bTextEditingController.text})x^3 +(${cTextEditingController.text}.m+${dTextEditingController.text})x^2+(${eTextEditingController.text}.m+${fTextEditingController.text})x+${gTextEditingController.text}.m+${hTextEditingController.text} nghịch biến trên (${pTextEditingController.text};${qTextEditingController.text})"),
