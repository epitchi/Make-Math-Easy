...
class TSHSB3_FoundMCkoCTPage extends StatefulWidget {
  @override
  _TSHSB3_FoundMCkoCTPageState createState() => _TSHSB3_FoundMCkoCTPageState();
}

List listAnswer = new List<String>();

class _TSHSB3_FoundMCkoCTPageState extends State<TSHSB3_FoundMCkoCTPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Tìm m để hàm số bậc 3 không có cực trị"),
        ),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                      "Tìm m để hàm số y = (am+b)x^3 +(cm+d)x^2+(em+f)x+gm+h không có cực trị "),
                  typeFunction != -1
                      ? Column(
                          children: [
