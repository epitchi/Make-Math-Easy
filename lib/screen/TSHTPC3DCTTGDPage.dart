...
class TSHTPCO3DCTTGDPage extends StatefulWidget {
  @override
  _TSHTPCO3DCTTGDPageState createState() => _TSHTPCO3DCTTGDPageState();
}

List listAnswer = new List<String>();

class _TSHTPCO3DCTTGDPageState extends State<TSHTPCO3DCTTGDPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text(
              "Tìm m hàm số trùng phương có 3 điểm cực trị tạo thành tam giác đều"),
        ),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                      "Tìm m để hàm số y = (am+b)x^4 + (cm+d)x^2 + em+f có ba điểm cực trị tạo thành tam giác đều"),
                  typeFunction != -1
                      ? Column(
                          children: [
                            Text("Đề bài",
                                style: TextStyle(fontWeight: FontWeight.bold)),
                            Text(
                                "Tìm m để hàm số y = (${aTextEditingController.text}m+${bTextEditingController.text})x^4 + (${cTextEditingController.text}m+${dTextEditingController.text})x^2 + ${eTextEditingController.text}m+${fTextEditingController.text} có ba điểm cực trị tạo thành tam giác đều"),
