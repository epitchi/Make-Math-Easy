...
class TSHTPCO3DCTTGVPage extends StatefulWidget {
  @override
  _TSHTPCO3DCTTGVPageState createState() => _TSHTPCO3DCTTGVPageState();
}

List listAnswer = new List<String>();

class _TSHTPCO3DCTTGVPageState extends State<TSHTPCO3DCTTGVPage> {
  ...
  GiaiTDDHS1() {
    ...
    db1 =
        "Bài 1: Tìm m để hàm số y = x^4 - m.x^2 + 1 có 3 điểm cực trị tạo thành một tam giác vuông";
    da1 =
        "Với m = 2 thì hàm số đã cho có 3 điểm cực trị tạo thành một tam giác vuông";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text(
              "Tìm m hàm số trùng phương có 3 điểm cực trị tạo thành tam giác vuông"),
        ),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                      "Tìm m để hàm số y = (am+b)x^4 + (cm+d)x^2 + em+f có ba điểm cực trị tạo thành tam giác vuông"),
                  typeFunction != -1
                      ? Column(
                          children: [
                            Text("Đề bài",
                                style: TextStyle(fontWeight: FontWeight.bold)),
                            Text(
                                "Tìm m để hàm số y = (${aTextEditingController.text}m+${bTextEditingController.text})x^4 + (${cTextEditingController.text}m+${dTextEditingController.text})x^2 + ${eTextEditingController.text}m+${fTextEditingController.text} có ba điểm cực trị tạo thành tam giác vuông"),
