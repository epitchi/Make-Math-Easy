...
class TSHSB3_TimMGTLNbangkPage extends StatefulWidget {
  @override
  _TSHSB3_TimMGTLNbangkPageState createState() =>
      _TSHSB3_TimMGTLNbangkPageState();
}

List listAnswer = new List<String>();

class _TSHSB3_TimMGTLNbangkPageState extends State<TSHSB3_TimMGTLNbangkPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Tìm m để hàm số bậc ba đạt GTLN bằng K trên [p,q]"),
        ),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                      "Tìm m để hàm số y = |a.x^3 +b.x^2+c.x+d + e.m| có GTLN bằng K trên [p,q]"),
                  typeFunction != -1
                      ? Column(
                          children: [
