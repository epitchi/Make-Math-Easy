...
class _TSHSB3_FoundMDBRPageState extends State<TSHSB3_FoundMDBRPage> {
  ...
  GiaiTDDHS1() {
    ...
    db1 =
        "Bài 1: Tìm m để hàm số y = 1.x^3 + (2m – 2).x^2 + 3.x – 2 đồng biến trên R";
    da1 = "Với m thuộc khoảng [-2;4] thì hàm số đã cho đồng biến trên R";
    db2 =
        "Bài 2: Tìm m để hàm số y = (m – 1).x^3 – (3m – 3).x^2 + 3.x + 2 đồng biến trên R";
    da2 = "Với m thuộc khoảng [1;2] thì hàm số đã cho đồng biến trên R";
    db3 =
