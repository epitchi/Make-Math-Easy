...
class TSHSB3_FoundMC2CTPage extends StatefulWidget {
  @override
  _TSHSB3_FoundMC2CTPageState createState() => _TSHSB3_FoundMC2CTPageState();
}

List listAnswer = new List<String>();

class _TSHSB3_FoundMC2CTPageState extends State<TSHSB3_FoundMC2CTPage> {
  ...
  GiaiTDDHS() {
    ...
    delta = _B * _B - 4 * _A * _C;
    if (a == 0)
      result1 = " Không có gúa trị m thỏa mãn ";
    else {
      if (_A < 0) {
        x0 = -_B / (2 * _A);
      ...
      if ((_A == 0) && (_B == 0)) if (_C == 0)
        result1 = "Không có giá trị m thỏa mãn ";
      else if (_C < 0)
        result1 = "Không có giá trị m thỏa mãn ";
      else
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Tìm m để hàm số bậc ba có 2 điểm cực trị"),
        ),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                      "Tìm m để hàm số y = (am+b)x^3 +(cm+d)x^2+(em+f)x+gm+h có hai điểm cực trị "),
                  typeFunction != -1
                      ? Column(
                          children: [
                            ...
                            Text(
                                "Tìm m để hàm số bậc 3: y = ( ${aTextEditingController.text}m+${bTextEditingController.text})x^3 +(${cTextEditingController.text} m+${dTextEditingController.text})x^2+(${eTextEditingController.text}m+f)x+${gTextEditingController.text}m+${hTextEditingController.text} có hai điểm cực trị "),
